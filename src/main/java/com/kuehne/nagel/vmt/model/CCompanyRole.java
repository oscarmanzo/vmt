...
/**
 * The persistent class for the c_company_role database table.
 * 
 */
@Entity
@Table(name="c_company_role")
@NamedQuery(name="CCompanyRole.findAll", query="SELECT c FROM CCompanyRole c")
public class CCompanyRole implements Serializable {
	...
	@OneToMany(mappedBy="CCompanyRole")
	...
	public RtHeadcountCompanyRole addRtHeadcountCompanyRole(RtHeadcountCompanyRole rtHeadcountCompanyRole) {
		...
		rtHeadcountCompanyRole.setCCompanyRole(this);
	...
	public RtHeadcountCompanyRole removeRtHeadcountCompanyRole(RtHeadcountCompanyRole rtHeadcountCompanyRole) {
		...
		rtHeadcountCompanyRole.setCCompanyRole(null);
